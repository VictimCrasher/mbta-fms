	...
	return (
		<div className="card bg-base-200 w-full h-auto min-h-[250px] flex flex-col gap-2 border-2 border-base-300 shadow-md">
			...
			<div className="flex flex-col gap-2 p-4 pt-2">
				<button
					className="btn btn-primary bg-(--color-tertiary) text-(--color-tertiary-content) hover:bg-(--color-tertiary-content) hover:text-(--color-tertiary) w-full flex items-center gap-2 justify-center"
					onClick={onClick}
				>
